...
import { validacionPassword } from '../../validaciones/validacionesModUsers.jsx';
		...
		<>
			<Modal show={StatusModalChangePassword} onHide={reserFormChangePasswordForm} scrollable={true} backdrop="static" keyboard={false}>
				...
				<Modal.Header closeButton>
					<Modal.Title><h4 className="modal-title"><i className="fas fa-user"></i> Cambiar contraseña</h4></Modal.Title>
				</Modal.Header>
				<Modal.Body>
						...
						<fieldset>
							...
							<div className="mb-3 position-relative">
								...
								<input className="form-control"
									...
									{...register("current_password", validacionPassword)}
									disabled={false}
								/>
								<i
			...
			<div className="navbar-item navbar-user dropdown">
				<a href="#" className="navbar-link dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
					<div className='me-2 bg-theme' style={{
						width: '25px',
						height: '25px',
						borderRadius: '50%',
						boxShadow: '2px 2px 2px rgba(100, 99, 99, 0.38)',
						color: 'white',
						display: 'flex',
						alignItems: 'center',
