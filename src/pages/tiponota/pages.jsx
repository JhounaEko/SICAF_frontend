...
const ManagerTipoNota = () => {
    ...
    return (<>
        <div className="card border-0 rounded-4 p-3 table-responsive container-shadow-card">
            <p className='fs-3 fw-bold fst-italic mb-1 text-shadow-sm' style={{ textShadow: '2px 2px 5px rgba(0, 0, 0, 0.3)' }}>Tipos de notas</p>
...
export default ManagerTipoNota;