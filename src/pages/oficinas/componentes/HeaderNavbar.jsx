...
const HeaderNavbar = ({ functionRefreschDataTable, searchData, searchDataParameter, searchDataLevel }) => {
    ...
    const [placeHolderInputSearch, setPlaceHolderInputSearch] = useState("nombre de oficina o abreviación");
    ...
    return (<>
        ...
        <div className="row">
            <div className="col-lg-2">
                <button className="btn btn-theme btn-rounded px-4 rounded-pill" onClick={openModal}><i className="fas fa-plus fa-1_5x"></i>Nueva oficina</button>
            </div>
