  ...
  const obtenerDatos = async () => {
    try {
      ...
      const respuesta = await axios.get(
        "http://127.0.0.1:8000/api/v1/states?sort_by=created_at&sort_order=asc",
        {
          headers: {
            Authorization:
              "Bearer 92|r207hKOF8nHDkk4d7SNog4Tm41LHgvHAqhriAEfO9f5b8a9e",
    ...
    <div>
      ...
      <div className="row">
        <div className="col-12">
          <Panel>
            <PanelHeader>Estados desde API</PanelHeader>
            <PanelBody>
              {loading ? (
                <p>
...
// 	function renderMap() {
// 		var componentActiveBg = (getComputedStyle(document.body).getPropertyValue('--bs-component-active-bg')).trim();
