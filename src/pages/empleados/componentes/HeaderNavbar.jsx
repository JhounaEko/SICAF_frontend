...
const HeaderNavbar = ({
  ...
  const [parameterSearchDataCreate, setParameterSearchDataCreate] =
    useState("search");
  const [placeHolderInputSearch, setPlaceHolderInputSearch] =
    useState("nombre");
  ...
  return (
    <>
      ...
      <CompModalCreateUpdate
        StatusModal={modal}
        title="Agregar registro de empleado"
      ...
      <div className="row">
        <div className="col-lg-3">
          <button
            ...
            onClick={openModal}
          >
            <i className="fas fa-plus fa-1_5x"></i> Agregar Empleado
          </button>
        </div>
        ...
        <div className="col-lg-2">
          ...
          >
            <option value="search">nombre de empleado</option>
            <option value="identity_card">celula de identidad</option>
            <option value="office_initials">abreviación de la oficina</option>
            <option value="office_name">nombre de oficina</option>
            <option value="place_name">nombre de cargo</option>
            <option value="state_name">estado de registro</option>
