...
const ManagerOrganizacionesFinanciamiento = () => {
    ...
    return (<>
        <div className="card border-0 p-3 table-responsive rounded-4 container-shadow-card">
            <p className='fs-3 fw-bold fst-italic mb-1 text-shadow-sm' style={{ textShadow: '2px 2px 5px rgba(0, 0, 0, 0.3)' }}>Organizaciones de financiamiento</p>
...
export default ManagerOrganizacionesFinanciamiento;