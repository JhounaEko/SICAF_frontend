    ...
    return (<>
        ...
        <div className="row">
            <div className="col-lg-2">
                <button className="btn btn-theme btn-rounded px-4 rounded-pill" onClick={openModal}><i className="fas fa-plus fa-1_5x" title = "Agregar registro"></i>organización</button>
            </div>
