...
const HeaderNavbar = ({
  ...
  <div className="col-lg-3 mb-2">
    <button
      ...
      onClick={openModal}
    >
      <i className="fas fa-plus fa-1_5x"></i> Agregar nuevo usuario
    </button>
  </div>

  {/* Filtro de búsqueda: por texto o fechas */}
  <div className="col-lg-4 mb-2">
    <Form.Group as={Row} controlId="searchDataUser">
        ...
        <div className="form-group row">
          ...
          <div className="col-12 mt-2 text-end">
            <button
              ...
              className="btn btn-sm btn-info btn-rounded rounded-pill"
            >
  ...
  <div className="col-lg-3 mb-2 d-flex justify-content-end gap-2">
    <button
    ...
    <button
      ...
      onClick={funtionActivePdf} // Puedes cambiar esto si quieres una función separada para Excel
    >
