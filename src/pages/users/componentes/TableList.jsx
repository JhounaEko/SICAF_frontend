...
import { messageFinallySesion, messageUpdateStatusRowSuccess, messageUpdateDataSuccess } from './../../../components/alert/alert.jsx';
		...
		},	
		{
			...
			<>
                  ...
                  <div className="navbar-item navbar-user dropdown" title = "Opciones para contraseña">                    
                    <a className="navbar-link dropdown-toggle d-flex align-items-center btn btn-sm btn-theme m-1" data-bs-toggle="dropdown">                  
                        <span>                            
