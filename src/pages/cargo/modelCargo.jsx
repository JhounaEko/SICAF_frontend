...
export const modelUseListCargoSelect = () => {
    const useListCargoSelect = async (getPag = 1, getSortColumn = 'id', getOrder = "desc", getCountRows = 10, getSearh = "") => {
