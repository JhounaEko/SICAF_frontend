...
/** Se utiliza para generar el pdf  */
    ...
    return (<>
        <div className="card border-0 p-3 table-responsive rounded-4 container-shadow-card ">
            ...
            <HeaderNavbar functionRefreschDataTable={functionRefreschDataTable} searchData={searchDataFunction} funtionActivePdf={funtionActivePdf} />
            <TableList getRefreschDataTable={getRefreschDataTable} getDataSearh={getDataSearh} functionGeneradorPdf={functionGeneradorPdf} />
        </div>
    </>);
}
